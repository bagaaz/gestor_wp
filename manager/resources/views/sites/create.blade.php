...
@section('title', 'Novo Site - WP Docker Manager')
@section('heading', 'Criar Novo Site WordPress')
...
@section('content')
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <form action="{{ route('sites.store') }}" method="POST" class="p-6 space-y-6" x-data="{ loading: false }" @submit="loading = true">
                @csrf
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
                    ...
                    <a href="{{ route('sites.index') }}" class="px-4 py-2.5 text-sm text-gray-600 hover:text-gray-800">
                        Cancelar
                    </a>
                </div>
            </form>
